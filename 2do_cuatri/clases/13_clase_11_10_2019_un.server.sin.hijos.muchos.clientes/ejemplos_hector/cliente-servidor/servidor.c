/**
 *	\file servidor.c
 *	\brief función main del servidor. Diapositivas de clase.
...
int main(void) {
		...
		int cliente; //Socket que se me conectó
		...
		// Enlazo el socket a la ip:puerto (contenida en la estructura que llené)
		...
		while(1){
			...
			while(clienteConectado){
				...
				if(sizeMensaje>0){
					...
					//imprimo mensaje
					buffer[sizeMensaje]='\0'; //Por las dudas pongo el \0, no me acuerdo si venía ya
