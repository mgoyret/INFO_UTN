...
#include <stdlib.h>//para pasar codigo de huella a string
...
void display(char*); //lo puse en minusciula para que no la mezcle con la funcion Display() de la biblioteca
void transmitir(char*);//idem
int leerSensorHuella( void ); // declaro para q compile
