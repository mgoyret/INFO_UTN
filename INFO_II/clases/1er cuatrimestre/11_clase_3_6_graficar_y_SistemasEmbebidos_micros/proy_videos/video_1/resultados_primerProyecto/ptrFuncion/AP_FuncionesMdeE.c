...
/**
*	\file AP_FuncionesMdeE.c
*	\brief Funciones de Eventos y Acciones asociadas a la M de E con puntero a funcion
...
/**
*	\fn void aEncenderLed( void )
*	\brief Resumen
*	\details Detalles
*	\author nosotros
*	\date 03-06-2020 12:26:55
*/
void aEncenderLed( void )
{
	//!< Codigo propio de la funcion
...
/**
*	\fn void aApagarLed( void )
*	\brief Resumen
*	\details Detalles
*	\author nosotros
*	\date 03-06-2020 12:26:55
*/
void aApagarLed( void )
{
	//!< Codigo propio de la funcion
