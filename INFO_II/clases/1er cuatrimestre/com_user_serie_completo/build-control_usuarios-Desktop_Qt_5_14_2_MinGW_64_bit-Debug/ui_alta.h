...
public:
    ...
    void setupUi(QDialog *alta)
    {
        ...
        splitter = new QSplitter(alta);
        splitter->setObjectName(QString::fromUtf8("splitter"));
        splitter->setGeometry(QRect(110, 20, 241, 241));
        splitter->setOrientation(Qt::Vertical);
        subtitulo = new QLabel(splitter);
        ...
        QWidget::setTabOrder(cancelButton, nombreLine);
        QWidget::setTabOrder(nombreLine, apellidoLine);
        QWidget::setTabOrder(apellidoLine, emailLine);
        QWidget::setTabOrder(emailLine, usuarioLine);
        QWidget::setTabOrder(usuarioLine, claveLine);
