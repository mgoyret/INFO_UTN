...
**********************************************************************************************************************************/
const void ( * arrayFunciones[ ] )( void ) = { funcion_APAGADO , funcion_ENCENDIDO };
...
**********************************************************************************************************************************/
static void funcion_APAGADO( void );
static void funcion_ENCENDIDO( void );

/*********************************************************************************************************************************
 *** FUNCIONES PRIVADAS AL MODULO
**********************************************************************************************************************************/
/**
*	\fn static void funcion_APAGADO ( void )
*	\brief Descripcion
*	\details Detalles
*	\author nosotros
*	\date 03-06-2020 12:26:55
...
/**
*	\fn static void funcion_ENCENDIDO ( void )
*	\brief Descripcion
*	\details Detalles
*	\author nosotros
*	\date 03-06-2020 12:26:55
