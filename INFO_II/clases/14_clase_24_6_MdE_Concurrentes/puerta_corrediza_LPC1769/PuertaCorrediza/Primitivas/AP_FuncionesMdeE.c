...
int HayPresencia( void )
{
	...
	if(GetPIN(KEY0,BAJO))	// Sensor Presencia
		res = 1;
...
int cerro( void )
{
	...
	if(GetPIN(KEY1,BAJO))	// Final de carrera cerrado
		res = 1;
...
int abrio( void )
{
	...
	if(GetPIN(KEY2,BAJO))	// Final de carrera abierto
		res = 1;
