...
#define	APAGADO         0
#define	PRENDIDO        1
#define SALIDA_FALSA    2
#define	REPOSO          3
#define	SALIO           4
#define	LLEGO           5
#define	NO_FINALIZADA   6
#define	FINALIZADA		7

#define TOTAL_N     5 //total de nadadores

//!< Definicion de respuestas de los pines conectados a las plataformas de la pileta
enum LANZA{
    LANZA1,
    LANZA2,
    LANZA3,
...
void maquina_control_nadadores(void);

void maquina_estado_de_carrera(void);
