...
/**
*	\fn void Iniciar_juego1()(void)
*	\brief Resumen
*	\details Detalles
*	\author NicoCampos
*	\date 03-09-2019 17:00:50
*/
void Iniciar_juego1( void )
{
...
/**
*	\fn void Iniciar_juego2()(void)
*	\brief Resumen
*	\details Detalles
*	\author NicoCampos
*	\date 03-09-2019 17:00:50
*/
void Iniciar_juego2( void )
{
	//!< Codigo propio de la funcion
	Habilitar_juego2();
}
...
/**
*	\fn void Iniciar_juego3()(void)
*	\brief Resumen
*	\details Detalles
*	\author NicoCampos
*	\date 03-09-2019 17:00:50
*/
void Iniciar_juego3( void )
{
	//!< Codigo propio de la funcion
	Habilitar_juego3();
}
